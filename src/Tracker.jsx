...
const PLAN = {
  ...
  note: "Judge feedback (OCB Natural Kingdom): front + delts already competitive; peak dialed. Bring up LAT WIDTH, HAMSTRING THICKNESS, and OBLIQUE/serratus tie-in to reach the top. Neck + elbow rules still apply: no overhead, no heavy pulldowns/curls, straps, neutral grips. Straight-arm and machine work carry the lat load safely. Start after Jacqueline's recovery; gated by time.",
  days: [
    { name: "Day 1 · Back width + hams", items: ["Straight-arm pulldown (wide) — 4×12-15  ● lat width", "Wide-grip seated row — 4×10-12  ● lats", "Machine pullover — 3×12  ● lats", "Seated leg curl — 4×12-15  ● hams", "Stiff-leg deadlift (light, controlled) — 3×10  ● hams", "Cable oblique crunch — 3×15  ● obliques"] },
    { name: "Day 2 · Delts + chest (maintain) + obliques", items: ["Cable lateral raise — 3×15", "Reverse pec-deck — 3×15", "Incline machine press — 3×10-12", "Lying leg curl — 3×15  ● hams", "Hanging oblique raise — 3×12  ● obliques", "Side plank — 3× hold"] },
    { name: "Day 3 · Lat width focus + hams", items: ["Machine pullover — 4×12-15  ● lats", "Wide-grip seated row — 4×10-12  ● lats", "Straight-arm pulldown — 3×15  ● lats", "Seated leg curl — 4×12-15  ● hams", "Cable oblique crunch — 3×15  ● obliques", "Calf raise — 3×15"] },
  ],
  updated: "Rebuilt from judge feedback, post OCB Natural Kingdom 2026",
};
