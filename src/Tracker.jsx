...
// Palette sampled directly from Mauro's OCB competition photo (Aug 2026), not invented:
// ink/waistband black, paper a cool neutral to sit under the blues, clay->shorts hem navy,
// sage->shorts crown blue, gold->skin tan, blush->hair brown. Same token names kept
// throughout the file on purpose — this is the only line that needed to change.
const C = {
  paper: "#EFF2F4", card: "#F8FAFB", ink: "#262422", sub: "#7C8B94",
  line: "#DCE3E8", clay: "#29497C", sage: "#72ADCD", gold: "#885A40", blush: "#4C3930",
};
