...
const PLAN = {
  ...
  days: [
    ...
    { name: "Day 3 · Delts + chest (maintain) + obliques", items: ["Cable lateral raise — 4×15", "Reverse pec-deck — 4×15", "Incline machine press — 3×10-12", "Lying leg curl — 3×15  ● hams", "Hanging oblique raise — 3×12  ● obliques", "Side plank — 3× hold"] },
  ...
  updated: "v4 · Day 4 rebuilt to vary lines of pull (was a near-duplicate of Day 1). Pullover, seated leg curl and RDL repeat on purpose: that is where load progression gets tracked.",
};
